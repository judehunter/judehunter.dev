...
export const createStore = <STATE, ACTIONS>(
  ...
  const actualActions = actions((setStateAction) => {
    const newVal = setStateAction instanceof Function ? setStateAction(state) : setStateAction;
...
const useSelector = <STATE extends any>(store: {state: STATE; subscribe: any}, selector: (state: STATE) => any) => {

...
createDate: '2022-09-30T10:00:00.000Z'
updateDate: '2022-09-30T10:00:00.000Z'
...
In practice, this would look very different, since selectors commonly allow any value to be returned. We will include that in the actual implementation. Additionally, React's built-in equality checking will do some heavy liftsing for us.

## Preventing deep re-renderes
